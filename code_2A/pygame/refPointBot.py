...
class RefPointBot(Bot):
    ...
    def __init__(self, x, y, radius, room, objective, randomObjective = False, randomInterval = 10, color = (0,255,0), haveObjective = True, radiusDetection = 200, showDetails = False, message = "RefPointBot",):
