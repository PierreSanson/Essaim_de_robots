    ...
    def draw(self):
        ...
        for hull in self.convexHulls:
            if len(hull)>=3:
                ...
                pygame.draw.polygon(self.surface, (0, 0, 100, 64), polygon)
        ...
        for coord in self.graph:
            if self.graph[coord][-1] == 1:
                ...
                pygame.draw.rect(self.surface, (200, 0, 200, 100), (coord[0]-self.gridWidth//2, coord[1] -self.gridWidth//2, self.gridWidth, self.gridWidth), width = 1)
            elif self.graph[coord][-1] == 1.5:
                pygame.draw.rect(self.surface, (0, 200, 200, 100), (coord[0]-self.gridWidth//2, coord[1] -self.gridWidth//2, self.gridWidth, self.gridWidth), width = 1)
            else:
        ...
        for coord in self.explorableClustersDict:
            pygame.draw.circle(self.surface, (200, 100, 0, 200), coord, 4)
        for coord in self.nearestPoints:
            p1 = coord[0]
            p2 = coord[1]
            a = (p1[1]-p2[1])/(p1[0]-p2[0])
            b = p1[1]-a*p1[0]
            pygame.draw.line(self.surface, (200, 0, 200, 200),(0,int(b)), (1600,int(a*1600+b)) , 1)
